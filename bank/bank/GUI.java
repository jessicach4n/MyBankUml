...
public class GUI extends Application {
    ...
    private Pane build_home_view() {
        ...
        merchant_col.setCellValueFactory(c -> c.getValue().merchant_property());
        date_col.setCellValueFactory(c -> c.getValue().date_property());
        card_col.setCellValueFactory(c -> c.getValue().card_property());
        amount_col.setCellValueFactory(c -> c.getValue().amount_property());
    ...
    public static class Transaction {
        private final javafx.beans.property.SimpleStringProperty merchant;
        private final javafx.beans.property.SimpleStringProperty date;
        private final javafx.beans.property.SimpleStringProperty card;
        ...
        public Transaction(String merchant, String date, String card, String amount) {
            this.merchant = new javafx.beans.property.SimpleStringProperty(merchant);
            this.date = new javafx.beans.property.SimpleStringProperty(date);
            this.card = new javafx.beans.property.SimpleStringProperty(card);
            this.amount = new javafx.beans.property.SimpleStringProperty(amount);
        }

        public javafx.beans.property.StringProperty merchant_property() { return merchant; }
        public javafx.beans.property.StringProperty date_property() { return date; }
